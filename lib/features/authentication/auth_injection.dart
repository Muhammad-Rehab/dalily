...
authInjectionContainer(){
  serverLocator.registerFactory(() => AuthenticationCubit(
      sendOtpUseCase: serverLocator(),
      loginUseCase: serverLocator(),
      registerUseCase: serverLocator(),));
  ...
  serverLocator.registerLazySingleton(() => RegisterUseCase(authRepository: serverLocator()));
