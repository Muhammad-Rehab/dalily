...
class _AdminWaitingListState extends State<AdminWaitingList> {
  ...
  acceptUserData({required ServiceOwnerModel serviceOwnerModel,required int index}){
    if(!_formKeys[index].currentState!.validate()){
      return ;
    }
    FocusScope.of(context).unfocus();
      BlocProvider.of<ServiceOwnerStateCubit>(context).updateServiceOwnerState(
          id: serviceOwnerModel.id ,state: AppStrings.acceptedState);
  ...
  rejectUserData(ServiceOwnerModel serviceOwnerModel){
    BlocProvider.of<ServiceOwnerStateCubit>(context).updateServiceOwnerState(
        id: serviceOwnerModel.id ,state: AppStrings.rejectedState,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ElevatedButton(
                                    onPressed: () {
                                      acceptUserData(serviceOwnerModel: serviceOwnerModel, index: index);
                                     },
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      rejectUserData(serviceOwnerModel);
                                      },
