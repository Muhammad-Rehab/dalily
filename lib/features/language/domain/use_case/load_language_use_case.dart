...
class LoadLanguageUseCase extends UseCase{
  LanguageRepository languageRepository ;
  LoadLanguageUseCase({required this.languageRepository});

  @override
  Future<Either<Failure, LanguageModel>> call(param) => languageRepository.loadLanguage();
